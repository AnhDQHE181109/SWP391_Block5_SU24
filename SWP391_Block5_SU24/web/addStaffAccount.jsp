<%-- 
    Document   : addStaffAccount
    Created on : Aug 11, 2024, 7:43:20 PM
    Author     : nobbe
--%>
...
<head>
    ...
    <link href="css/bootstrap_manager.min.css" rel="stylesheet">
    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                <a href="manager_home.jsp" class="navbar-brand d-flex d-lg-none me-4">
