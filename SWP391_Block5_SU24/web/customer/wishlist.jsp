                            ...
                            <c:if test="${wishlistItems != null && !wishlistItems.isEmpty()}">
                                <c:forEach var="item" items="${wishlistItems}">
                                    <div class="product-cart d-flex">
                                        <div class="one-forth">
                                            <div class="product-img" style="background-image: url(${pageContext.request.contextPath}/${item.imageURL});"></div>
                                        ...
                                        <div class="one-eight text-center">
                                            <div class="display-tc">
                                                <a href="CartController?action=add&stockId=${item.productId}" class="btn btn-primary">Add to Cart</a>
                                            </div>
                                        </div>
                                        <div class="one-eight text-center">
                                            <div class="display-tc">
                                                <a href="WishlistController?action=remove&wishlistId=${item.productId}" class="closed"></a>
                                            </div>
                                        </div>
                                    </div>
                                </c:forEach>
