<%-- 
    Document   : history_requests
    Created on : Aug 23, 2024, 6:17:47 AM
    Author     : nobbe
--%>
    ...
    <body>
        <div class="container-fluid position-relative bg-white d-flex p-0">
            ...
            <div class="content">
                ...
                <!-- History Requests Table Start -->
                <div class="container-fluid pt-4 px-4">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">Processed Requests History</h6>
                    ...
                    <div class="pagination">
                        <ul class="pagination">
                            <%
                            String countQuery = "SELECT COUNT(*) FROM ReturnRequests WHERE Status IN ('Approved', 'Rejected')";
                            ...
                            %>
                                <li class="<%= (i == currentPage) ? "active" : "" %>">
                                    <a href="history_requests.jsp?page=<%= i %>"><%= i %></a>
                                </li>
                            <%
                            }
                            %>
