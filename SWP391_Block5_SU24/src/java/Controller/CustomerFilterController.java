 ...
 * @author Long
 */
@WebFilter(filterName = "CustomerFilterController", urlPatterns = {"/customer/*","/shoppingCart", "/WishlistController", "/BuyAgainController", "/CancelOrderController", "/ChangeController", "/ChangeCustomerController", "/ChangeEmailController", "/ChangePassController", "/ChangePhoneNumberController", "/CheckoutController", "/LoadNotificationController", "/NotificationController", "/OrderReceivedController", "/RecoverController", "/RemoveWishlistController", "/ReturnRequestController", "/shoppingCart", "/SubmitFeedbackController", "/WishlistController"})
